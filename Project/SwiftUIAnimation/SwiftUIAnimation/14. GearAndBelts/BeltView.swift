    ...
    var body: some View {
        ZStack {
            Capsule()
                ...
                .animation(.linear(duration: 3).repeatForever(autoreverses: false).speed(3), value: animateBelt)
        }
...
struct BeltView_Previews: PreviewProvider {
    static var previews: some View {
        BeltView(beltWidth: 380, beltHeight: 48, offsetBeltX: 0, offsetBeltY: 0, rotateDegrees: 90)
