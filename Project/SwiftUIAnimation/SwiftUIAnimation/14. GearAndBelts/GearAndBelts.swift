...
struct GearAndBelts: View {
    var body: some View {
        ZStack {
            
            // ZStack은 .zIndex modifier로 뷰의 순서를 바꿀 수 있지만, .background modifier는 항상 부모 뷰 위에 있다.
            // 여기서는 background modifier에 추가해도 되지만 ZStackdp zIndex를 사용해서 추가하였음
...
struct GearAndBelts_Previews: PreviewProvider {
